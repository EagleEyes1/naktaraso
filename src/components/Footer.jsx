...
const Footer = () => {
  return (
    <footer class="bg-white rounded-lg xl:px-36 lg:px-32 md:px-20 shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
