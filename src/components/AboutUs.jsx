...
const AboutUs = () => {
  return (
    <>
        ...
        <div className="pt-6 grid grid-cols-2">
          <div className="self-center">
            ...
            <p className="text-lg leading-8">
              ...
              <br /> Dengan bangga kami sampaikan bahwa produk kami telah
              mendapatkan sertifikat halal dari LPPOM MUI. Produksi telah
              distandardisasi sesuai Good Manufacturing Practices (GMP) dan
              Hazar Analysis and Critical Control Point (HACCP). Setiap hari
              kami menerapkan standardisasi tersebut untuk mencapai produk
              berkualitas tinggi.
            </p>
          </div>
          <div className="pl-28">
      ...
      <div className="text-lg leading-8 bg-[#ffeedc] px-56 py-12">
